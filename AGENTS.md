...
- **Scope Changes Require Approval:** If you believe a milestone's scope is blocking progress or has technical flaws, do not change it on your own. Present the issue to the user and request updated parameters.
