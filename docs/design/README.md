...
| File                       | Content                                                                                                     |
| -------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `full-design.dc.html`      | Full visual reference for the dashboard, work view, editor, settings, dialogs, and component states         |
| `interactive-demo.dc.html` | Clickable review-loop demo                                                                                  |
| `support.js`               | Runtime used by the `.dc.html` files; open the HTML files in a browser from this folder                     |
