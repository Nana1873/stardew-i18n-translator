...
- [interactive-demo.dc.html](interactive-demo.dc.html): Clickable review-loop demo.
- [support.js](support.js): Runtime used by the `.dc.html` files. Open the HTML files in a
...
For current UI changes and verification, see [CONTRIBUTING.md](../../CONTRIBUTING.md).
