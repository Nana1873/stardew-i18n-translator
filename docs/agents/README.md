...
When you finish a task, always write a handoff summary using the [Handoff Template](../../docs/agents/handoff-template.md) at the end of your run to ensure a seamless transition for the next agent or developer.
