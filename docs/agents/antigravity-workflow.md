...
### Step 1: Read Context
* Read the root [SPEC.md](file:///SPEC.md) and [SCOPE_GUARDRAILS.md](file:///SCOPE_GUARDRAILS.md) before writing any code.
...
* Compare any architectural ideas against [SCOPE_GUARDRAILS.md](file:///SCOPE_GUARDRAILS.md). If they introduce complexity, abstractions, or features not in [SPEC.md](file:///SPEC.md), reject them.
